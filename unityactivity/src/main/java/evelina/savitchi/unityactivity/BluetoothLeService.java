...
public class BluetoothLeService extends Service {
    public final static String BT_SERVICE_ID = "BT_SERVICE";
    public final static int BT_SERVICE_START = 1;
    public final static int BT_SERVICE_STOP = 2;
    public final static int BT_SERVICE_PAUSE = 3;
    ...
    private final static String MYO_ARMBAND_NAME = "My Myo";
    ...
    private final static UUID MYO_INFO_CHAR_UUID =
            UUID.fromString("d5060101-a904-deb9-4748-2c7f4a124842");
    private final static UUID MYO_FW_VERSION_CHAR_UUID =
            UUID.fromString("d5060201-a904-deb9-4748-2c7f4a124842");
    private final static UUID MYO_CMD_CHAR_UUID =
            UUID.fromString("d5060401-a904-deb9-4748-2c7f4a124842");
    private final static UUID MYO_EMG_DATA_0_CHAR_UUID =
            UUID.fromString("d5060105-a904-deb9-4748-2c7f4a124842");
    private final static UUID MYO_EMG_DATA_1_CHAR_UUID =
            UUID.fromString("d5060205-a904-deb9-4748-2c7f4a124842");
    private final static UUID MYO_EMG_DATA_2_CHAR_UUID =
            UUID.fromString("d5060305-a904-deb9-4748-2c7f4a124842");
    private final static UUID MYO_EMG_DATA_3_CHAR_UUID =
            UUID.fromString("d5060405-a904-deb9-4748-2c7f4a124842");
    private final static UUID MYO_IMU_DATA_CHAR_UUID =
            UUID.fromString("d5060402-a904-deb9-4748-2c7f4a124842");
    private final static UUID BATTERY_LEVEL_CHAR_UUID =
            UUID.fromString("00002a19-0000-1000-8000-00805f9b34fb");
    private final static UUID DEVICE_NAME_CHAR_UUID =
            UUID.fromString("00002a00-0000-1000-8000-00805f9b34fb");
    private final static UUID CCC_DESCRIPTOR_UUID =
            UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");

    private final static int MyoSkuUnknown = 0;
    private final static int MyoSkuBlack = 1;
    private final static int MyoSkuWhite = 2;
    private final static int MyoHwRevUnknown = 0;
    private final static int MyoHwRevC = 1;
    private final static int MyoHwRevD = 2;
    private final static byte SerialNumberSize = 6;
    private final static byte ReadOperation = 0;
    private final static byte NotifyOperation = 1;
    private final static String SKU =
            "com.local.miomario.service.BluetoothLeService.SKU";
    private final static String MAJOR_FW_VERSION =
            "com.local.miomario.service.BluetoothLeService.MAJOR_FW_VERSION";
    private final static String MINOR_FW_VERSION =
            "com.local.miomario.service.BluetoothLeService.MINOR_FW_VERSION";
    private final static String FW_PATCH =
            "com.local.miomario.service.BluetoothLeService.FW_PATCH";

    private final static byte NO_INDEX = -1;

    // parameters for mode setup
    private final static byte ModeFrameSize = 5;
    private final static byte ModePayloadSize = 3;
    private final static byte CommandSetMode = 1;
    private final static byte EmgModeSendEmg = 2;
    private final static byte ImuModeSendData = 1;
    private final static byte ClassifierModeDisabled = 0;

    // parameters for sleep setup
    private final static byte SleepFrameSize = 3;
    private final static byte SleepPayloadSize = 1;
    private final static byte CommandSetSleep = 9;
    private final static byte NeverSleepMode = 1;

    private final static byte EmgCharacteristicDataSize = 16;
    private final static byte ImuCharacteristicDataSize = 20;
                ...
                switch (mBtServiceState) {
                    case SERVICE_STOPPED: {
                        ...
                        NotificationCompat.Builder builder = new NotificationCompat.Builder(
                                this, PluginActivity.BT_SERVICE_CHANNEL_ID)
                                .setContentTitle(PluginActivity.BT_SERVICE_CHANNEL_NAME)
                                .setContentText(PluginActivity.BT_SERVICE_CHANNEL_DESCRIPTION)
    ...
    public void onCreate() {
        ...
        if (initBtAdapter()) {
            writeCommand = WriteCommand.Sleep;
            mScanning = false;
            mConnectionState = STATE_DISCONNECTED;
            mBtServiceState = BluetoothServiceState.SERVICE_STOPPED;
    ...
    private void processFoundCharacteristics() {
        if (btChars != null) {
            if (btChars.size() > 0) {
                ...
                writeCommandCharacteristic(writeCommand);

                switch (writeCommand) {
                    case Mode:
                        writeCommand = WriteCommand.None;
                        break;
                    case Sleep:
                        writeCommand = WriteCommand.Mode;
                        break;
                    default:
                        break;
                }
    ...
    private void writeCommandCharacteristic(WriteCommand cmd) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapter not initialized");
            return;
        }
        ...
        if (cmd == WriteCommand.Mode) {
            byte[] frame = new byte[ModeFrameSize];
            frame[0] = CommandSetMode;
            frame[1] = ModePayloadSize;
            ...
            if (!mBluetoothGatt.writeCharacteristic(mMyoCommandCharacteristic)) {
                Log.w(TAG, "Myo command characteristic write failed - Mode");
            }
        } else if (cmd == WriteCommand.Sleep) {
            byte[] frame = new byte[SleepFrameSize];
            frame[0] = CommandSetSleep;
            frame[1] = SleepPayloadSize;
            frame[2] = NeverSleepMode;
            mMyoCommandCharacteristic.setValue(frame);
            if (!mBluetoothGatt.writeCharacteristic(mMyoCommandCharacteristic)) {
                Log.w(TAG, "Myo command characteristic write failed - Sleep");
            }
        }
    }
